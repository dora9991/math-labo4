...
export default function Home({ player, records, mistakeCount, onTimeAttack, onSlow, onBattle, onUnitTest, onNotebook }) {
    ...
    <div className="app">
      ...
      <div className="content" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="mode-grid">
          ...
          <button className="mode-card mut" onClick={onUnitTest}>
            <span style={{ fontSize: 36 }}>📝</span>
            <span style={{ fontSize: 15, fontWeight: 900 }}>単元テスト</span>
            <span style={{ fontSize: 11, opacity: 0.8, lineHeight: 1.5 }}>実力をチェック</span>
          </button>
        </div>
